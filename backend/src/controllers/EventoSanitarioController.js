...
export default class EventoSanitarioController {
    ...
    static async update(req, res) {
        try {
            ...
            if (diagnostico !== undefined) updateData.diagnostico = diagnostico ? diagnostico.trim() : null;
            if (tratamiento !== undefined) updateData.tratamiento = tratamiento ? tratamiento.trim() : null;
