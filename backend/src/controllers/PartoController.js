...
export default class PartoController {
    ...
    static async update(req, res) {
        try {
            ...
            if (prenez_id !== undefined) {
                ...
                // VALIDACIÓN: Verificar que no existe otro parto para el nuevo diagnóstico
    ...
    static async search(req, res) {
        try {
            ...
            return res.status(500).json({
                ok: false,
                msg: "Error al buscar partos"
            });
        }
    }

    static async getPartosPorFecha(req, res) {
        try {
            ...
            return res.status(500).json({
                ok: false,
                msg: "Error al obtener los partos por fecha"
            });
        }
    }
}