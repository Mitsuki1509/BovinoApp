...
CREATE TABLE compras_insumos (
    compra_insumo_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE detalle_compras_insumos (
    compra_insumo_id INT REFERENCES compras_insumos(compra_insumo_id),
    insumo_id INT REFERENCES insumos(insumo_id),
    precio DECIMAL(10,2) NOT NULL,
    cantidad INT NOT NULL,
    deleted_at TIMESTAMP NULL,
    PRIMARY KEY (compra_insumo_id, insumo_id) 
);

CREATE TABLE compras_animales (
    compra_animal_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    numero_compra VARCHAR(20) NOT NULL,
    proveedor_id INT REFERENCES proveedores(proveedor_id),
    fecha DATE NOT NULL,
    deleted_at TIMESTAMP NULL
...
CREATE TABLE detalle_compras_animales (
    compra_animal_id INT REFERENCES compras_animales(compra_animal_id),
    animal_id INT REFERENCES animales(animal_id),
    precio DECIMAL(10,2) NOT NULL,
    observaciones TEXT,
    deleted_at TIMESTAMP NULL,
    PRIMARY KEY (compra_animal_id, animal_id) 
);

CREATE TABLE evento_sanitario (
    evento_sanitario_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    numero_evento VARCHAR(20),
    animal_id INT REFERENCES animales(animal_id),
...
CREATE TABLE alimentacion (
    ...
    numero_alimentacion VARCHAR(20),
    insumo_id INT REFERENCES insumos(insumo_id),
    animal_id INT REFERENCES animales(animal_id),
    cantidad INT NOT NULL,
    fecha DATE NOT NULL,
...
CREATE TABLE pesajes (
    ...
    animal_id INT REFERENCES animales(animal_id),
    unidad_id INT REFERENCES unidades(unidad_id),
    numero_pesaje VARCHAR(20),
    peso DECIMAL(10,2) NOT NULL,
    fecha DATE NOT NULL,
    deleted_at TIMESTAMP NULL
);

CREATE TABLE mataderos (
    matadero_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ubicacion VARCHAR(255) NOT NULL,
    deleted_at TIMESTAMP NULL
);
...
CREATE TABLE produccion_carne (
    ...
    animal_id INT REFERENCES animales(animal_id),
    pesaje_id INT REFERENCES pesajes(pesaje_id),
    matadero_id INT REFERENCES mataderos(matadero_id),
    peso_canal DECIMAL(10,2) NOT NULL,
    unidad_id INT REFERENCES unidades(unidad_id),
    fecha DATE NOT NULL,
    deleted_at TIMESTAMP NULL
);
...
CREATE TABLE produccion_lechera (
    produccion_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    animal_id INT REFERENCES animales(animal_id),
    numero_produccion VARCHAR(20) NOT NULL,
    cantidad INT NOT NULL,
    unidad_id INT REFERENCES unidades(unidad_id),
    fecha DATE NOT NULL,
    descripcion TEXT,
...
CREATE TABLE notificaciones (
  notificacion_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  usuario_id INT NULL REFERENCES usuarios(usuario_id),
...
INSERT INTO public.usuarios(finca_id,
    rol_id, 
    nombre, 
    correo, 
    contraseña, 
